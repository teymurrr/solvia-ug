...
const ProfessionalCard: React.FC<ProfessionalCardProps> = ({ professional }) => {
  ...
  const handleSubmitMessage = async () => {
    if (!messageData.subject || !messageData.content || !professional.id) {
      toast({
    ...
    const result = await addMessage({
      sender_id: '', // This will be filled by the backend with the current user's ID
      recipient_id: String(professional.id),
    ...
    if (result) {
      toast({
        title: "Message sent",
        description: `Your message has been sent to ${professional.firstName} ${professional.lastName}`,
      });
    ...
    <>
      ...
      <Dialog open={isMessageDialogOpen} onOpenChange={setIsMessageDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Send Message to {professional.firstName} {professional.lastName}</DialogTitle>
          </DialogHeader>
