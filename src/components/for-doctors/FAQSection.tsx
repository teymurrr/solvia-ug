...
const FAQSection = () => {
  ...
  const getFaqs = () => {
    if (t?.forDoctors?.faq?.items) {
      return t.forDoctors.faq.items;
    }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-6">
            {t?.forDoctors?.faq?.title || "Frequently Asked Questions"}
          </h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            {t?.forDoctors?.faq?.subtitle || "Get answers to the most common questions about working as a doctor in Germany"}
          </p>
