    ...
    <section className="hero-gradient text-white py-16">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-[42px] font-bold mb-4 leading-tight">{title}</h2>
          <p className="text-lg md:text-xl lg:text-[20px] mb-8 leading-relaxed">{subtitle}</p>
