export const pathToSuccess = {
  ...
  subtitle: 'Wir unterstützen Sie in jeder Phase — von der Anerkennung bis zur Umsiedelung.',
  stepLabel: 'Schritt',
  cta: 'Meine Reise Beginnen',
  ctaLabel: 'Meine Reise mit Solvia Beginnen',
  steps: {
    'step1.title': 'Anmeldung',
    'step1.description': 'Zugang zu allen Informationen für den Umzug und Verbindung zu einer Gemeinschaft von Ärzten mit dem gleichen Ziel: Arbeiten in Europa.',
    ...
    'step4.description': 'Finden Sie Ihren neuen Job mit höherem Gehalt und bester Arbeitszufriedenheit.',
    'step5.title': 'Umsiedelung & Integration',
