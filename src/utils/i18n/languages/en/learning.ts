...
export const learning = {
  ...
  joinProfessionals: "Join over 1000+ healthcare professionals who chose Solvia Learning",
  ...
  courseDescription1: "Complete German language courses specifically designed for healthcare professionals",
  courseDescription2: "Intensive preparation for the Fachsprachprüfung with proven success methods",
  medicalVocabularyFocus: "Medical vocabulary focus",
  interactiveLessons: "Interactive lessons",
  nativeSpeakerInstructors: "Native speaker instructors",
  mockExams: "Mock exams",
  oneOnOneCoaching: "1-on-1 coaching",
  passRatePercent: "95% pass rate"
};
