export const landing = {
  jobExplorer: {
    ...
    subtitle: "Find your future job in Europe's top hospitals and clinics.",
    realJob: "Real Position",
    sampleJob: "Example Position",
    sampleDisclaimer: "Sample job for illustration",
    viewOffersForProfile: "View offers for my profile",
    countries: {
      germany: "Germany",
      austria: "Austria", 
      spain: "Spain",
    ...
    jobs: {
      job1: {
        ...
        institution: "University Hospital Berlin",
    ...
    stories: [
      ...
      },
      {
        ...
        details: {
          ...
          hiredAt: "Hamburg University Hospital"
        }
      }
    ]
  },
  ...
  conversionFaq: {
    ...
    subtitle: "Get answers to your most important questions",
    viewPlanFor: "View my plan for",
    items: [
      {
