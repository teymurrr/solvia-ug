...
export const forDoctors = {
  ...
  usp: {
    ...
    subtitle: "Thousands of doctors face a complex process when moving to Germany. At Solvia, we make it simple. Here's what makes us different:",
    items: [
      {
  ...
  faq: {
    ...
    subtitle: "Get answers to the most common questions about working as a doctor in Germany",
    items: [
      {
  ...
  positions: {
    ...
    subtitle: "Discover exciting opportunities at leading healthcare institutions across Germany",
  ...
  successStories: {
    ...
    subtitle: "Meet doctors who transformed their careers with Solvia and are now thriving in Germany",
    originallyFrom: "Originally from",
    ctaText: "Join thousands of doctors who chose Solvia",
    stories: [
      {
        name: "María Fernanda",
        country: "Colombia",
