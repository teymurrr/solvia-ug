export const learning = {
  ...
  starterKit: {
    badge: '🔥 Le plus populaire pour l\'Allemagne',
    badgeDynamic: '🔥 Le plus populaire pour {country}',
    limitedPrice: 'Prix de lancement limité',
    title: 'Kit de Démarrage d\'Allemand Médical',
    description: 'Tout ce dont vous avez besoin pour commencer votre carrière médicale en Allemagne — livré instantanément par e-mail.',
    item1: '50 Phrases Essentielles d\'Allemand Médical (PDF)',
    item2: 'Guide de Structure et Calendrier du FSP (PDF)',
    item3: 'Feuille de Route : A1 à Approbation (PDF)',
    item4: '10 Fichiers Audio de Prononciation Médicale',
    item5: 'Checklist des Documents pour l\'Approbation',
    item6: 'Bonus : Consultation Gratuite de 15 min',
    item1Dynamic: '50 Phrases Essentielles de {language} Médical (PDF)',
    item2Dynamic: 'Guide de Structure et Calendrier du {exam} (PDF)',
    item3Dynamic: 'Feuille de Route : A1 à {license} (PDF)',
    item4Dynamic: '10 Fichiers Audio de Prononciation Médicale en {language}',
    item5Dynamic: 'Checklist des Documents pour {license}',
    socialProof: 'Plus de 500 professionnels ont commencé ici',
    oneTime: 'Paiement unique',
    cta: 'Obtenir le Kit',
    guarantee: 'Garantie satisfait ou remboursé 30 jours',
    heroTitle: 'Commencez Votre Carrière Médicale en Allemagne Aujourd\'hui',
    heroTitleDynamic: 'Commencez Votre Carrière Médicale en {country} Aujourd\'hui',
    heroSubtitle: 'Obtenez tout ce dont vous avez besoin pour faire le premier pas — phrases, guides d\'examen, feuille de route et une consultation gratuite — pour seulement 29€.',
    heroSubtitleDynamic: 'Obtenez tout ce dont vous avez besoin pour faire le premier pas — phrases, guides d\'examen, feuille de route et une consultation gratuite — pour seulement 29€.',
    emailLabel: 'Votre e-mail (pour livraison instantanée)',
    emailRequired: 'Veuillez entrer votre e-mail',
    processing: 'Traitement en cours...',
    buyNow: 'Acheter Maintenant — 29€',
    secure: 'Paiement sécurisé',
    instant: 'Livraison instantanée',
    faqTitle: 'Questions Fréquemment Posées',
    faq1q: 'Quel est le format des documents ?',
    faq1a: 'Tous les documents sont livrés en PDF téléchargeables et fichiers audio MP3. Vous recevez un accès instantané par e-mail après l\'achat.',
    faq2q: 'Est-ce uniquement pour les médecins ?',
    faq2a: 'Non ! Le Kit est conçu pour tous les professionnels de santé — médecins, infirmiers, pharmaciens et étudiants en médecine souhaitant travailler en Allemagne.',
    faq2aDynamic: 'Non ! Le Kit est conçu pour tous les professionnels de santé — médecins, infirmiers, pharmaciens et étudiants en médecine souhaitant travailler en {country}.',
    faq3q: 'Puis-je obtenir un remboursement ?',
    faq3a: 'Oui. Nous offrons une garantie de remboursement intégral de 30 jours, sans conditions.',
    finalCtaTitle: 'Prêt à commencer votre parcours vers l\'Allemagne ?',
    finalCtaTitleDynamic: 'Prêt à commencer votre parcours vers {country} ?',
    finalCtaSubtitle: 'Obtenez votre Kit de Démarrage maintenant et faites le premier pas.',
  },
