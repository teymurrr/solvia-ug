export const landing = {
  jobExplorer: {
    ...
    subtitle: "Trouvez votre futur emploi dans les meilleurs hôpitaux et cliniques d'Europe.",
    realJob: "Poste Réel",
  ...
  homologationIncluded: {
    ...
    features: [
      ...
      "Suivi continu de votre processus"
    ],
    featureSubtexts: [
  ...
  successStories: {
    ...
    ctaText: "Voir mon plan d'homologation",
    socialProof: "Nous avons déjà aidé des médecins et infirmiers de 12 pays à commencer leur homologation",
    stories: [
      {
        name: "María Fernanda",
        country: "Colombie",
      ...
      },
      {
        ...
        details: {
          ...
          hiredAt: "Hôpital Universitaire de Munich"
        }
      },
      {
        name: "Ana Lucía",
  ...
  countryComparison: {
    ...
    countries: {
      ...
      italy: {
        name: "Italie",
        flag: "🇮🇹",
        processDuration: "3–8 mois",
        price: "€750",
        highlight: "Demande croissante",
        salary: "3 500–9 000",
        includes: ["Préparation des documents", "Support de reconnaissance", "Placement professionnel"]
      }
    }
  },
  conversionFaq: {
