        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              {t?.learning?.hero?.title || 'Advance Your Medical Career with'} <span className="text-primary">Solvia Learning</span>
            </h1>
                  ...
                  <>
                    <div className="text-center mb-8">
                      <h2 className="text-3xl font-bold text-gray-900 mb-4">
                        {t?.learning?.signupForm?.title || 'Fill the form for a'} <span className="text-primary">{t?.learning?.signupForm?.title ? '' : 'Free Consultancy'}</span>
                      </h2>
